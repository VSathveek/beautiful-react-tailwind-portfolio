...
export const ContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to send. Please email me directly at sathveekvaranasi@gmail.com",
        variant: "destructive",
      });
    } finally {
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 justify-center">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:sathveekvaranasi@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    sathveekvaranasi@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/vsathveek" target="_blank" rel="noopener noreferrer">
                  <Linkedin />
                </a>
                <a href="https://github.com/VSathveek" target="_blank" rel="noopener noreferrer">
                  <Github />
                </a>
              </div>
            </div>
